...
if vim.g.os == 'Darwin' then
    vim.api.nvim_create_autocmd("FileType", {
        pattern = "cpp",
        callback = function()
            vim.api.nvim_buf_set_keymap(0, 'n', '<leader>fn', ':!g++ -std=c++11 -o %:r % && open -a Terminal \'./a.out\'<CR>', { noremap = true, silent = true })
            vim.api.nvim_buf_set_keymap(0, 'n', '<leader>fb', ':!g++ -std=c++11 % && ./a.out<CR>', { noremap = true, silent = true })
